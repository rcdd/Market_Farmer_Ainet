    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                  <img src="<?php echo e(asset('assets/images/market1.jpg')); ?>" alt="...">
            ...
            <div class="item">
                  <img src="<?php echo e(asset('assets/images/market2.jpg')); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
            </div>
            ...
            <div class="item">
                  <img src="<?php echo e(asset('assets/images/market3.jpg')); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
            </div>
            ...
            <div class="item">
                  <img src="<?php echo e(asset('assets/images/market4.jpg')); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
            </div>
